...
const {createOrder, sayHello, getSingleOrder, getMyOrder, getAllOrders, updateOrderStatus, deleteOrder, getAdminOrderDetails} = require("../controllers/orderController");
...
Router.route("/admin/order/:id")
    .get(isAuthenticatedUser, isAuthorizedRoles("admin"), getAdminOrderDetails)
